...
public class FormMover extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ubi_nueva = (EditText) findViewById(R.id.txt_ubi_ant);
        ...
        btn_qr_nue = (Button) findViewById(R.id.qr_ant);
    ...
    void mover(){
        ...
        if (ubi_antigua.getText().toString().isEmpty() || ubi_nueva.getText().toString().isEmpty() ){
            ...
            String parametros =  "ubi_nueva="+ubica_nueva+"&ubi_antigua="+ubica_ant+"&usuario="+usuario;
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == REQ_CODE_SPEECH_INPUT2){
            if (resultCode == RESULT_OK && null != data)
            {
                ...
                ubi_nueva.setText(result.get(0));
            }
        }
        if (requestCode == REQ_CODE_SPEECH_INPUT2){
            if (resultCode == RESULT_OK && null != data)
